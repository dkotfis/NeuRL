...
public class MarioTesting7 extends GlueMario {
	...
	public static ParameterHolder changeParams(ParameterHolder params) {
		...
		params.addIntegerParam("level seed", 212212321);
		params.addIntegerParam("level type", 1);
		params.addIntegerParam("level difficulty", 10);
		return params;
	}
	
	public MarioTesting7(ParameterHolder params) {
	...
	public static void main(String[] args) {
        new EnvironmentLoader(new MarioProving7(MarioProving7.getDefaultParameters())).run();
	}
}
