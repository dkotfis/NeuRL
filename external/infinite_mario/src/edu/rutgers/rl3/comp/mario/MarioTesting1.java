...
public class MarioTesting1 extends GlueMario {
	...
	public static ParameterHolder changeParams(ParameterHolder params) {
		...
		params.addIntegerParam("level seed", 22112321);
		params.addIntegerParam("level type", 0);
		params.addIntegerParam("level difficulty", 0);
		return params;
	}
	
	public MarioTesting1(ParameterHolder params) {
	...
	public static void main(String[] args) {
        new EnvironmentLoader(new MarioProving1(MarioProving1.getDefaultParameters())).run();
	}
}
