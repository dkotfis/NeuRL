...
public class MarioTesting10 extends GlueMario {
	...
	public static ParameterHolder changeParams(ParameterHolder params) {
		...
		params.addIntegerParam("level seed", 211991321);
		params.addIntegerParam("level type", 0);
		params.addIntegerParam("level difficulty", 15);
		return params;
	}
	
	public MarioTesting10(ParameterHolder params) {
	...
	public static void main(String[] args) {
        new EnvironmentLoader(new MarioProving10(MarioProving10.getDefaultParameters())).run();
	}
}
